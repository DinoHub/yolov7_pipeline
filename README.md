...
2. [Setting Up on NVIDIA Jetson (Xavier/Orin)](#setting-up-on-nvidia-jetson-xavierorin)
    ...
    2. [Setup Instructions](#setup-instructions)
        1. [Flashing Ubuntu](#flashing-ubuntu)
        2. [Date & Time Adjustment (if applicable)](#date--time-adjustment-if-applicable)
        3. [External Disk Automount Configuration](#external-disk-automount-configuration)
        4. [Docker Installation](#docker-installation)
        5. [NVIDIA Container Toolkit Installation (for GPU Usage)](#nvidia-container-toolkit-installation-for-gpu-usage)
        6. [Relocating Docker Storage (if required) - Insufficient Storage Capacity](#relocating-docker-storage-if-required---insufficient-storage-capacity)
        7. [Installing tmux (if required)](#installing-tmux-if-required)
