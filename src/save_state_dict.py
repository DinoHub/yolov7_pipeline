...
if __name__ == '__main__':
    ...
    parser.add_argument('--delete_reparam', action='store_true', help='Delete reparameterized model file after saving')
    ...
    if opt.delete_reparam:
        os.remove(opt.weights)
        print(f"Deleted reparameterized model file at {opt.weights}")
