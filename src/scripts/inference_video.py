...
vid_path = Path('/data/test.mp4')
weights="/models/best_final.pt"
...
# vid_reader = imageio.get_reader(str(vid_path))
# fps = vid_reader.get_meta_data()['fps']
# vid_writer = imageio.get_writer(str(out_fp), fps=fps)
...
#     vid_writer.append_data(show_frame)
